...
export default class ReactIntense extends Component<Props, State> {
  constructor(props: Props) {
    ...
    this.state = {
      ...
      overflowXValue: body && document.body.style.overflowX,
      overflowYValue: body && document.body.style.overflowY,
      target: {
        width: 0,
        height: 0,
      },
  ...
  unlockBody () {
    if (document.body && this.state.overflowValueX && this.state.overflowValueY) {
      document.body.style.overflowX = this.state.overflowValueX;
