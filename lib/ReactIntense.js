...
export default class ReactIntense extends Component<Props, State> {
  constructor(props: Props) {
    ...
    this.state = {
      ...
      overflowXValue: body && body.style.overflowX,
      overflowYValue: body && body.style.overflowY,
      target: {
        width: 0,
        height: 0,
      },
  ...
  lockBody () {
    console.log(this.state.overflowXValue, this.state.overflowYValue);
    if (document.body) {
  ...
  unlockBody () {
    if (document.body && this.state.overflowXValue && this.state.overflowYValue) {
      document.body.style.overflowX = this.state.overflowXValue;
      document.body.style.overflowY = this.state.overflowYValue;
    }
  }
